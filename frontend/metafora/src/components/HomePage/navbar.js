                        ...
                        <div className="navbar-text">
                            <div className="desktop-menu">
                                <ul className="navbar-list">
                                    ...
                                    {loggedIn?<button className="menu-item navbar-button" onClick={() => logout()}>logout</button> :<button className="menu-item navbar-button" onClick={() => navigate('/login')}>login</button>}
                            ...
                            <div className="mobile-menu">
                                <Menu right>
                                    ...
                                    <button className="menu-item navbar-button" onClick={() => navigate('/login')}>{loggedIn ?'Logout':'login'}</button>
                                </Menu>
                            </div>
                        </div>
                    </nav>
