                            ...
                            {isCustomerView ? (
                                ...
                                <>
                                    <div className="aboutPage-subcontent">
                                        ...
                                        <span><p><TiTick className="tick"/>Expand your reach by connecting with our wide customer base.</p></span>
                                    </div>
                                    <div className="aboutPage-subcontent">
                                        <h1>Reliable Partnerships</h1>
                                        <span><p><TiTick className="tick"/>Build trust and reliability with our seamless platform.</p></span>
                                    </div>
                                    <div className="aboutPage-subcontent">
                                        <h1>Growth Opportunities</h1>
                                        <span><p><TiTick className="tick"/>Leverage our network to grow your business efficiently.</p></span>
                                    </div>
                                </>
                            )}
                        </div>
